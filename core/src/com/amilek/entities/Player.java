...
public class Player extends SpaceObject {
    ...
    private float acceleratingTimer; //for flame animation purposes
    ...
    public Player(ArrayList<Bullet> bullets) {
        ...
        //polygon arrow like shape
        shapex = new float[4];
        shapey = new float[4];

        //flame booster shape (3 verticies shape)
        flamex = new float[3];
        flamey = new float[3];
    ...
    public void shoot() {
        ...
        bullets.add(new Bullet(x, y, radians)); // creating bullet at player position
    }
    ...
    public void update(float dt) {
        ...
        //animate flame only if we are accelerating
        if (up) {
            setFlame();
        }
